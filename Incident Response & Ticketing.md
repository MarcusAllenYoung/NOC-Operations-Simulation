...
- [**Incident 01**](Incident%2001%20-%20BRANCH-PC1%20Connectivity%20Incident.md) 🔌 A Sev 3 endpoint connectivity incident detected through LibreNMS and tracked in Spiceworks. Troubleshooting isolated the issue to the BRANCH-PC1 access connection, followed by onsite Tier 1 troubleshooting, physical connection restoration, connectivity validation, and ticket closure.
