...
### 🔀 Logical Topology
<img width="866" height="357" alt="Screenshot 2026-09-12 231911" src="https://github.com/user-attachments/assets/fb2ababc-b907-49b7-81ee-c8b1842a1d9a" />
...
LibreNMS alerting was configured to detect meaningful network and monitoring failures.
...
<img width="932" height="254" alt="Image" src="https://github.com/user-attachments/assets/f48e8c63-2aee-4688-a3fa-614ee00aa515" />
...
<img width="947" height="322" alt="Image" src="https://github.com/user-attachments/assets/13db293c-f18d-46c9-8782-4db49b0bb2e2" />

### 🚨 Alert & Recovery Verification

A controlled SNMP monitoring failure was generated on SW-01 while ICMP and SSH connectivity remained operational.

LibreNMS detected the loss of SNMP polling and generated a critical alert. After SNMP access was restored, normal polling resumed and the alert condition recovered.

**SW-01 SNMP Failure & Recovery**
